# software_apt-transport-https
=========

This role will install apt-transport-https software
...
--------------------
    ...
    ---
    - src: git@github.com:xussof/software_apt-transport-https
      scm: git
      version: master
      name: software_apt-transport-https
